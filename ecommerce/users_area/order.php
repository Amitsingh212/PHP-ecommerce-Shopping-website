...
$get_ip_addres= getIPAddress();
$total_price=0;
$cart_query_price="select * from cart_details where ip_address='$get_ip_addres'";
...
//delete cart from items
$empty_cart="delete from cart_details where ip_address='$get_ip_addres'";
