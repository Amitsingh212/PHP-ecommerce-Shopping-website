...
<body>
    <section id="header">
     ...
     <section id="about-head" class="section-p1">
      ...
      <div>
        <h2>who are you</h2>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quos cumque consequuntur, cupiditate animi omnis aliquid laborum ea placeat molestiae perspiciatis ipsa, assumenda error accusamus ad mollitia nostrum asperiores at quaerat.</p>
     ...
     <footer class="section-p1">
       ...
       <div class="col install">
         ...
         <div class="row">
           <img src="images/playstore.png" width="100"height="100" alt="">
